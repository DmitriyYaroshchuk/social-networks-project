...
const popupSubscribeButtonBasic= document.querySelector('#popupSubscribeButtonBasic');
const popupSubscribeButtonStandard= document.querySelector('#popupSubscribeButtonStandard');
...
popupSubscribeButtonBasic.addEventListener('click',function () {
    popupSubscribe.classList.add('active')
    popupSubscribeWrapper.classList.add('active')
    body.classList.add('noscroll')
});

popupSubscribeButtonStandard.addEventListener('click',function () {
    popupSubscribe.classList.add('active')
    popupSubscribeWrapper.classList.add('active')
    body.classList.add('noscroll')
});
