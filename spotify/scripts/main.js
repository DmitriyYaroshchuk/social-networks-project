...
const popupSubscribeButtonIndividual = document.querySelector('#popupSubscribeButtonIndividual');
const popupSubscribeButtonDuo = document.querySelector('#popupSubscribeButtonDuo');
const popupSubscribeButtonFamily = document.querySelector('#popupSubscribeButtonFamily');
...
popupSubscribeButtonIndividual.addEventListener('click',function () {
    popupSubscribe.classList.add('active')
    popupSubscribeWrapper.classList.add('active')
    body.classList.add('noscroll')
});

popupSubscribeButtonDuo.addEventListener('click',function () {
    popupSubscribe.classList.add('active')
    popupSubscribeWrapper.classList.add('active')
    body.classList.add('noscroll')
});

popupSubscribeButtonFamily.addEventListener('click',function () {
    popupSubscribe.classList.add('active')
    popupSubscribeWrapper.classList.add('active')
    body.classList.add('noscroll')
});
